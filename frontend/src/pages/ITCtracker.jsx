...
function ITCTracker() {
  ...
  <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
    ...
    {/* Title */}
    <div className="mb-6">
      <h1 className="text-2xl md:text-3xl font-semibold">ITC Tracker</h1>
      <p className="text-gray-500 text-sm">Monitor your Input Tax Credit</p>
    </div>
    ...
    <div className="bg-white rounded-xl border p-4 md:p-6 mb-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div>
          ...
          <p className="text-green-600 text-xs md:text-sm flex items-center gap-1 mt-1">
            <TrendingUp size={14} />
    ...
    <div className="bg-white rounded-xl border overflow-hidden mb-6">
      ...
      {purchases.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 md:py-16 gap-3 text-gray-400 px-4 text-center">
          <AlertCircle size={32} className="text-gray-300" />
          <p className="text-xs md:text-sm">
            No purchase data available. Add purchases to track ITC.
          </p>
        </div>
      ) : (
        <div className="overflow-x-auto">
          ...
          <table className="w-full text-xs md:text-sm min-w-[750px]">
            ...
            <thead className="bg-gray-50 text-gray-500 uppercase text-[10px] md:text-xs tracking-wide">
              <tr>
                ...
                <th className="px-4 md:px-6 py-3 text-right">Taxable (₹)</th>
                <th className="px-4 md:px-6 py-3 text-right">ITC (GST Paid) (₹)</th>
              </tr>
            </thead>
            ...
            <tbody className="divide-y divide-gray-100">
              {purchases.map((bill) => (
                <tr key={bill.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4 text-gray-500 font-mono text-[10px] md:text-xs">
                    {bill.vendorGstin}
                  </td>
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4 text-right text-gray-700">
            ...
            <tfoot className="bg-green-50">
              <tr>
                <td
                  colSpan={5}
                  className="px-4 md:px-6 py-3 text-xs md:text-sm font-semibold text-gray-700"
                >
                  Total ITC Available
                </td>
                <td className="px-4 md:px-6 py-3 text-right text-green-700 font-bold text-xs md:text-sm">
                  ₹{totalITC.toLocaleString("en-IN")}
                </td>
              </tr>
            </tfoot>
    ...
    <div className="bg-white rounded-xl border p-4 md:p-6">
      <h3 className="text-sm md:text-base font-semibold text-blue-600 mb-2">
