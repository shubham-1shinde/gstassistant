  ...
  <div className="p-4 md:p-8 bg-gray-50 min-h-screen">
    ...
    <div className="mb-6">
      ...
      <p className="text-gray-500 text-xs md:text-sm mt-1">
        Manage all registered accountants
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
      ...
      <div className="bg-white rounded-xl border p-4 md:p-5 flex items-center gap-4
    ...
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          className="
            w-full border border-gray-200 rounded-lg pl-9 pr-4 py-2.5
      ...
      {/* Filter Tabs */}
      <div className="flex bg-white border border-gray-200 rounded-lg p-1 gap-1 w-full sm:w-auto">
        ...
        {["all", "active", "inactive"].map((f) => (
          <button
            ...
            onClick={() => setFilter(f)}
            className={`
              flex-1 sm:flex-none px-3 md:px-4 py-1.5 rounded-md text-sm font-medium capitalize
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className={`
                    ...
                    w-10 md:w-11 h-10 md:h-11 rounded-full
                  ...
                  <div>
                    ...
                    <span className={`
                      inline-block text-[10px] md:text-xs font-semibold px-2 py-0.5 rounded-full mt-0.5
                      ${acc.status === "active"
